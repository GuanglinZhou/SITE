...
class SiteNet(object):

    def __init__(self, x, t, y_, p_t, FLAGS, r_lambda, do_in, do_out, dims, three_pairs, three_pairs_simi,
        ...
        self._build_graph(x, t, y_, p_t, FLAGS, r_lambda, do_in, do_out, dims, three_pairs, three_pairs_simi,
                          r_mid_point_mini, r_pddm)
    ...
    def _build_graph(self, x, t, y_, p_t, FLAGS, r_lambda, do_in, do_out, dims, three_pairs, three_pairs_simi,
                     r_mid_point_mini, r_pddm):
        ...
        for i in range(0, FLAGS.n_in):
            ...
            if FLAGS.varsel and i == 0:
                ...
                # z_batch is used to calculate MPDM and PDDM
                ...
                if FLAGS.batch_norm:
                    ...
                    if FLAGS.normalization == 'bn_fixed':
                        ...
                        z_batch = tf.nn.batch_normalization(z_batch, batch_mean_batch, batch_var_batch,
                                                            bn_biases_batch[-1], bn_scales_batch[-1], 1e-3)
                """

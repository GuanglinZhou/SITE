...
if __name__ == "__main__":
    ...
    # main(dataform='/Users/guanglinzhou/Documents/Code/SITE/data/ihdp_npci_1-100.train.npz',
    #      propensity_dir='/Users/guanglinzhou/Documents/Code/SITE/data/propensity_dir')
